...
from omnisci_olio.dashboard.dashboard_utils import DashboardUtils


def main(args: argparse.Namespace):
    backend = omnisci_olio.ibis.connect() # create ibis backend at the start and finally close it at end
